...
struct StoryBeatControls: View {
    ...
    @State var universalEmotionLoading: Bool = false
    @State var universalQuestionsLoading: Bool = false
    ...
    func runUniversalEmotionAI() {
        DispatchQueue.main.async {
            Task {
                universalEmotionLoading = true
                
                defer {
                    universalEmotionLoading = false
                }
    ...
    func runAI() {
        ...
        DispatchQueue.main.async {
            Task {
                universalQuestionsLoading = true
                
                defer {
                    universalQuestionsLoading = false
                }
